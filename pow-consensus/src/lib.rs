...
// We want to touch this code as little as possible, yet we don't want to be flooded with warnings
// This will enable easy cherry-picking into an upstream patch
#![allow(clippy::all)]
#![allow(warnings)]
